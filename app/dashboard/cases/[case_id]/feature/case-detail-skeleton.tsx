  ...
  <div className="animate-pulse">
    ...
    <section className="mb-8">
      <div className="flex flex-col justify-between gap-5 xl:flex-row xl:items-start">
        ...
        <div className="flex gap-3">
          <div className="h-10 w-40 rounded-control bg-line" />
          <div className="h-10 w-32 rounded-control bg-line" />
          <div className="h-10 w-48 rounded-control bg-line" />
        </div>
      </div>
    </section>
    ...
    <div className="grid items-start gap-6 xl:grid-cols-[340px_minmax(0,1fr)]">
      <aside className="space-y-5">
        ...
        <div className="h-24 rounded-card border border-line bg-white shadow-panel" />
      </aside>
